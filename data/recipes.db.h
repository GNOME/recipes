...
N_("[timer:00:25:00]Bake for 25-30 minutes or until a cake tester inserted into the center cake comes out clean. The cake should have a nice golden colour.")
...
N_("[image:1]Start by boiling about 1 litre of water for each 100g of pasta.")
N_("[image:1]Once the water is boiling, pour 20g of coarse salt in it for every litre of water, and then throw the spaghetti in.")
N_("[image:1]While the pasta is cooking, take a large bowl and put the parmesan cheese in it.")
N_("[image:2]Add the whole egg and the yolks to the parmesan, and beat the eggs until you get a creamy sauce.")
N_("[image:3]Put the guanciale in a small pan with a teaspoon of oil, and shallow fry it until the fat is transparent and the meat is crispy; then remove from the fire.")
N_("[image:5]Once the pasta is ready, drain it and add it to the eggs and cheese. Then, add the guanciale.")
N_("[image:6]Season with salt and pepper to your liking.")
...
N_("[timer:00:15:00]Pre-bake the dough for 15 minutes in the oven.")
...
N_("[timer:00:35:00]Bake the pie in the oven for 35 minutes.")
N_("[image:1]Enjoy!")
N_("Spanish Omelet")
...
N_("[timer:00:40:00]Put in the oven at [temperature:180C] for 40 minutes.")
...
N_("[timer:00:40:00]Poor the cake mixture into the cake tin and bake for around 40 minutes, until the top is light brown and an inserted skewer comes out clean.")
N_("[timer:00:05:00]Leave the cake to cool for 5 minutes, then turn out on to a rack to cool completely.")
...
N_("[timer:00:03:00]Sautee the onion, tofu, and peppers for 3-5 minutes using the vegan butter.")
N_("[timer:00:05:00]Turn heat down to medium and add the rest of the ingredients – cook for 5-7 minutes more.")
N_("Donauwellen")
...
N_("[timer:00:30:00]Bake for 30 minutes at [temperature:200C].")
