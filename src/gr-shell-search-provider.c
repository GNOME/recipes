               ...
               PendingSearch  *pending_search)
{
        ...
        for (l = hits; l; l = l->next) {
                ...
                pending_search->results = g_list_prepend (pending_search->results, (gpointer)gr_recipe_get_name (recipe));
        }
}
                         ...
                         gpointer                 user_data)
{
        ...
        for (i = 0; results[i]; i++) {
                ...
                g_variant_builder_add (&meta, "{sv}", "id", g_variant_new_string (gr_recipe_get_name (recipe)));
                ...
                g_hash_table_insert (self->metas_cache, g_strdup (gr_recipe_get_name (recipe)), g_variant_ref_sink (meta_variant));
